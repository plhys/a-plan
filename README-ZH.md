...
<a href="https://trendshift.io/repositories/15832" target="_blank"><img src="https://trendshift.io/api/badge/repositories/15832" alt="justlovemaki%2FA计划 | Trendshift" style="width: 250px; height: 55px;" width="250" height="55"/></a>
</div>

<div align="center">

<a href="https://deepwiki.com/justlovemaki/A计划"><img src="https://deepwiki.com/badge.svg" alt="Ask DeepWiki"  style="width: 134px; height: 23px;margin-bottom: 3px;"></a>
...
[![GitHub stars](https://img.shields.io/github/stars/justlovemaki/A计划.svg?style=flat&label=Star)](https://github.com/justlovemaki/A计划/stargazers)
[![GitHub issues](https://img.shields.io/github/issues/justlovemaki/A计划.svg)](https://github.com/justlovemaki/A计划/issues)
...
<table width="100%">
  ...
  <tr>
    ...
    <td width="75%" align="left" valign="middle">
      Poixe AI 提供可靠的 AI 模型接口服务，您可以使用平台提供的 LLM API 接口轻松构建 AI 产品，同时也可以成为供应商，为平台提供大模型资源以赚取收益。<a href="https://poixe.com/i/ebmvga">通过 A计划 专属链接注册</a>，充值额外赠送 <strong>$5 美金</strong>。
    </td>
  </tr>
  <tr>
    <td width="25%" align="center" valign="middle">
...
使用 A计划 最推荐的方式是通过自动化脚本启动，并直接在 **Web UI 控制台** 进行可视化配置。
...
#### Kiro 扩展思考 (Claude 模型)
A计划 在使用路由到 `claude-kiro-oauth` 的 Claude 兼容请求 (`/v1/messages`) 或 OpenAI 兼容请求 (`/v1/chat/completions`) 时支持 Kiro 扩展思考。
...
感谢以下所有为 A计划 项目做出贡献的开发者：

[![Contributors](https://contrib.rocks/image?repo=justlovemaki/A计划)](https://github.com/justlovemaki/A计划/graphs/contributors)


### 🌟 Star History


[![Star History Chart](https://api.star-history.com/svg?repos=justlovemaki/A计划&type=Timeline)](https://www.star-history.com/#justlovemaki/A计划&Timeline)
...
### 使用风险提示
本项目（A计划）仅供学习和研究使用。用户在使用本项目时，应自行承担所有风险。作者不对因使用本项目而导致的任何直接、间接或 consequential 损失承担责任。
